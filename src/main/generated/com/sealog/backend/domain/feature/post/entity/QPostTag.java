...
public class QPostTag extends EntityPathBase<PostTag> {
    ...
    private static final long serialVersionUID = -721954047L;
    ...
    public final com.sealog.backend.domain.feature.tag.entity.QTag tag;
    ...
    public QPostTag(Class<? extends PostTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.tag = inits.isInitialized("tag") ? new com.sealog.backend.domain.feature.tag.entity.QTag(forProperty("tag")) : null;
    }

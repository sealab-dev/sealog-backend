...
public class QPost extends EntityPathBase<Post> {
    ...
    private static final long serialVersionUID = -628461095L;
    ...
    public final com.sealog.backend.domain.feature.series.entity.QSeries series;

    public final StringPath slug = createString("slug");

    public final EnumPath<com.sealog.backend.domain.feature.post.enums.PostStatus> status = createEnum("status", com.sealog.backend.domain.feature.post.enums.PostStatus.class);
    ...
    public QPost(Class<? extends Post> type, PathMetadata metadata, PathInits inits) {
        ...
        this.series = inits.isInitialized("series") ? new com.sealog.backend.domain.feature.series.entity.QSeries(forProperty("series"), inits.get("series")) : null;

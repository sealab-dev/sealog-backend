...
@DisplayName("StackAdmin 통합 테스트 (Controller → Service → Repository)")
class StackAdminIntegrationTest extends TestIntegrationBase {
    ...
    class 스택_생성 {
        ...
        void 성공() throws Exception {
            CustomUserDetails adminDetails = new CustomUserDetails(admin);
            StackAdminRequest.Create request = StackAdminRequest.Create.builder()
                    .name("Spring Boot")
    ...
    class 스택_수정 {
        ...
        void 성공() throws Exception {
            ...
            CustomUserDetails adminDetails = new CustomUserDetails(admin);
            StackAdminRequest.Update request = StackAdminRequest.Update.builder()
                    .name("수정된스택명")
                    .stackGroup("framework")
                    .build();
    ...
    class 스택_삭제 {
        ...
        void 성공() throws Exception {
            ...
            mockMvc.perform(delete("/api/admin/stacks/{stackId}", stack.getId())
                            .with(SecurityMockMvcRequestPostProcessors.user(adminDetails)))
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.message").value("스택이 삭제되었습니다"));
        }
